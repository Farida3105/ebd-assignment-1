...
Hero: Farida the Warrior
Student ID: 16001437
GitHub account: farida3105

A **Chimera** bars the way near **the Giza plateau**. It only falls to
the exact blow.
...
1. Your hero name
2. Your student ID
3. Your power — your student ID **multiplied by 4**
4. Your warcry — copy the line below exactly, including punctuation:

   "By the Giza plateau, the Chimera kneels!"
